...
export function ContactSection() {
    ...
    return (
        <section id="contact" className="scroll-mt-24 mb-16 md:mb-24">
            ...
            {/* ── CV section ── */}
            <div className="rounded-2xl border border-border/60 bg-card/80 backdrop-blur-sm p-6 sm:p-8 md:p-10 shadow-sm flex flex-col md:flex-row items-center gap-6 md:gap-10">
