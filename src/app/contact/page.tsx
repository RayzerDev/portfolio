  ...
  return (
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container grid gap-8 px-4 md:px-6 lg:grid-cols-2 lg:gap-12 mx-auto">
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="mailto:louis.karamucki@outlook.fr" className="text-primary-foreground hover:underline">
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-secondary">Télécharger mon CV</h2>
              <p className="text-muted-foreground md:text-xl/relaxed">
            ...
            <Link
                ...
                target="_blank"
                download
                className="inline-flex h-10 items-center justify-center rounded-md bg-secondary px-8 text-sm font-medium
