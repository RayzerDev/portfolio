                ...
                <header className="bg-primary text-foreground py-6 px-4 md:px-6 gap-4 ">
                    <div className="container mx-auto flex items-center justify-between">
                        ...
                        <nav className="flex items-center gap-4 flex-wrap justify-center ml-8">
                            <Link href="/skills" className="text-lg font-medium hover:scale-110 transition"
                                  prefetch={false}>
                                Compétences
                            </Link>
                            <Link href="/projects" className="text-lg font-medium hover:scale-110 transition"
                                  prefetch={false}>
                                Projets
                            </Link>
                            <Link href="/contact" className="text-lg font-medium hover:scale-110 transition"
                                  prefetch={false}>
                                Contact
                            </Link>
                            <Link href="https://github.com/RayzerDev"
                                  className="text-lg font-medium hover:scale-110 transition" prefetch={false}
                                  target="_blank">
                                <Github/>
                            </Link>
